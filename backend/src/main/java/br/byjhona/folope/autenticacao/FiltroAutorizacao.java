...
public class FiltroAutorizacao extends OncePerRequestFilter {
    ...
    public FiltroAutorizacao(JwtTokenService jwtService, ServicoPersonalizadoUsuarioDetalhes userDetailsService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            String username = jwtService.obterUsuarioToken(token);
